...
*/
ALTER TABLE PERSON_ADDRESSES ADD CONSTRAINT PERSON_ADDRESSES_ibfk_1 FOREIGN KEY (PERSON_ID) REFERENCES PERSONS (ID) ON UPDATE No action ON DELETE No action;
ALTER TABLE PERSON_ADDRESSES ADD CONSTRAINT PERSON_ADDRESSES_ibfk_2 FOREIGN KEY (ADDRESS_ID) REFERENCES ADDRESSES (ID) ON UPDATE No action ON DELETE No action;
...
ALTER TABLE CALENDAR_EVENTS ADD CONSTRAINT FKCALENDAR_E760270 FOREIGN KEY (CALENDAR_ID) REFERENCES CALENDAR_MASTER (ID);
